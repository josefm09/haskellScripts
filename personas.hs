...
Type Nacimiento = Int
Type Muerte = Int 
Type Persona = (Nombre,Trabajo,Nacimiento,Muerte)
...
vivas :: Int -> [ Nombre ]
vivas a = [ nom | (nom,_,nace,muere) <- personas ]
